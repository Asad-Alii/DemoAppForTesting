...
import com.alqaswa.user.Adapter.WalletAdapter;
import com.alqaswa.user.HttpRequester.AsyncTaskCompleteListener;
import com.alqaswa.user.HttpRequester.VollyRequester;
import com.alqaswa.user.Models.User;
import com.alqaswa.user.Models.Wallets;
import com.alqaswa.user.RealmController.RealmController;
...
public class NikolaWalletActivity extends AppCompatActivity implements View.OnClickListener, AsyncTaskCompleteListener {
    ...
    private void getWalletBalance() {
        ...
        if (userprofile != null) {
            ...
            new VollyRequester(this, Const.GET, map, Const.ServiceCode.WALLET_BALANCE,
                    this, mapHead);
        }
    }
