...
public class TypesAdapter extends BaseAdapter {
    ...
    private Context ctx;
    private ArrayList<TaxiTypes> typeslst;


    public TypesAdapter(Context context,ArrayList<TaxiTypes>typeslst) {
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
        ...
        textView.setText(typeslst.get(position).getTaxitype());
