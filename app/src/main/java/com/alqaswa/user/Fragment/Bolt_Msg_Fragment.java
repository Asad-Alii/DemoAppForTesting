...
import com.alqaswa.user.Adapter.BoltTypesAdapter;
import com.alqaswa.user.Adapter.SearchPlaceAdapter;
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (s_LatLng != null) {
                            ...
                            Glide.with(activity).load(img).into(iv_source_map);
                        } else {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (d_latlan != null) {
                            ...
                            Glide.with(activity).load(url).into(iv_dest_map);
                        } else {
                           /* clearAll();
                            AndyUtils.showShortToast("Please re enter!",activity);*/
